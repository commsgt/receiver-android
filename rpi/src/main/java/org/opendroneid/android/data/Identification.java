...
public class Identification extends MessageData {
    ...
    public enum UaTypeEnum {
        None, Aeroplane, Helicopter_or_Multirotor, Gyroplane,
    ...
    public enum IdTypeEnum {
        None, Serial_Number, CAA_Registration_ID, UTM_Assigned_ID, Specific_Session_ID,
    }
    ...
    public String toString() {
        return "Identification{uaType=" + uaType + ", idType=" + idType + ", uasId=" + Arrays.toString(uasId) + '}';
    }
}
